...
public class Clock {
   /**
    * Class field definintions go here CONSTANTS first
    */
   ...
   /**
    * Constructor Not really anything to do here, so just call the "super()" which
    * is "Object"
    */
   public Clock() {
      super();
   ...
   /**
    * Method to calculate the next tick from the time increment each "tick" will be
    * the number of seconds in the time slice
    * 
    ...
    * @return double-precision value of the argument or -1.0 if invalid note: if
    *         the main program determines there IS no optional argument supplied, I
    *         have elected to have it substitute the string "60.0" and call this
    *         method anyhow. That makes the main program code more uniform, but
    *         this is a DESIGN DECISION, not a requirement! note: remember that the
    *         time slice, if it is small will cause the simulation to take a VERY
    ...
    * 
    * @return double-precision value of the hour hand location NOTE: the hour hand
    *         moves 360 degrees in 43200 seconds, which works out to be 0.00834
    *         degrees per second
    */
    ...
    * 
    * @return double-precision value of the minute hand location NOTE: the minute
    *         hand moves 360 degrees in 3600 seconds, which works out to be 0.1
    *         degrees per second
    */
   ...
   /**
    * Method to fetch the total number of seconds we can use this to tell when 12
    * hours have elapsed
    * 
   ...
   /**
    * The main program starts here remember the constraints from the project
    * description
    * 
    * @see http://bjohnson.lmu.build/cmsi186web/homework04.html be sure to make
    *      LOTS of tests!! remember you are trying to BREAK your code, not just
    *      prove it works!
    */
   public static void main(String args[]) {
      ...
      try {
         System.out.println((90.0 == clock.validateAngleArg("90.0")) ? " - got  90.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((150.0 == clock.validateAngleArg("150.0")) ? " - got 150.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((180.0 == clock.validateAngleArg("180.0")) ? " - got 180.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((270.0 == clock.validateAngleArg("270.0")) ? " - got 270.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((360.0 == clock.validateAngleArg("360.0")) ? " - got 360.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out
               .println((INVALID_ARGUMENT_VALUE == clock.validateAngleArg("-10.0")) ? " - got INVALID_ARGUMENT_VALUE"
                     : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out
               .println((INVALID_ARGUMENT_VALUE == clock.validateAngleArg("ABC")) ? " - got exception" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((390.0 == clock.validateAngleArg("390.0")) ? " - got 390.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((0.0 == clock.validateTimeSliceArg("0.0")) ? " - got exception" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((10.0 == clock.validateTimeSliceArg("10.0")) ? " - got   10.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((30.0 == clock.validateTimeSliceArg("30.0")) ? " - got   30.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println(
               (INVALID_ARGUMENT_VALUE == clock.validateTimeSliceArg("ABC")) ? " - got exception" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((90.0 == clock.validateTimeSliceArg("90.0")) ? " - got   90.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((500.0 == clock.validateTimeSliceArg("500.0")) ? " - got  500.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((1000.0 == clock.validateTimeSliceArg("1000.0")) ? " - got 1000.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println((1800.0 == clock.validateTimeSliceArg("1800.0")) ? " - got 1800.0" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println(
               (INVALID_ARGUMENT_VALUE == clock.validateTimeSliceArg("1805.0")) ? " - got exception" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t " + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 0.0 minutes, 0.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 0.0 minutes, 10.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 0.0 minutes, 20.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 0.0 minutes, 30.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 1.0 minutes, 0.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 2.0 minutes, 0.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 3.0 minutes, 40.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 5.0 minutes, 20.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }

      clock.timeJunque = clock.tick(clock.timeJunque[0], clock.timeJunque[1], clock.timeJunque[2], timeSlice); // 7
                                                                                                               // minutes
      System.out.print("      expecting string with 0.0 for hours, 7.0 minutes, and 0.0000 seconds values");
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 7.0 minutes, 0.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 25.0 minutes, 20.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   0.0 hours, 50.0 minutes, 27.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      clock.timeJunque = clock.tick(clock.timeJunque[0], clock.timeJunque[1], clock.timeJunque[2], timeSlice); // 2:05
                                                                                                               // 48
      ...
      try {
         System.out.println(
               (clock.toString().equals("   4.0 hours, 36.0 minutes, 30.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   5.0 hours, 6.0 minutes, 19.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   6.0 hours, 5.0 minutes, 57.0000 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   6.0 hours, 5.0 minutes, 57.1230 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   6.0 hours, 5.0 minutes, 57.3690 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   6.0 hours, 5.0 minutes, 58.1070 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println((0.1 >= (Math.abs(clock.getHourHandAngle() - 183.131))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println((0.1 >= (Math.abs(clock.getMinuteHandAngle() - 35.811))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println((0.1 >= (Math.abs(clock.getHandAngle() - 147.321))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   6.0 hours, 35.0 minutes, 58.1070 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      System.out.print("      expecting double angle value of approximately 17.668 degrees");
      try {
         System.out.println((0.1 >= (Math.abs(clock.getHandAngle() - 17.668))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   7.0 hours, 5.0 minutes, 58.1070 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      System.out.print("      expecting double angle value of approximately 177.344 degrees");
      try {
         System.out.println((0.1 >= (Math.abs(clock.getHandAngle() - 177.344))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   7.0 hours, 35.0 minutes, 58.1070 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      System.out.print("      expecting double angle value of approximately 12.356 degrees");
      try {
         System.out.println((0.1 >= (Math.abs(clock.getHandAngle() - 12.356))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      ...
      try {
         System.out.println(
               (clock.toString().equals("   10.0 hours, 5.0 minutes, 58.1070 seconds")) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
      System.out.print("      expecting double angle value of approximately 92.584 degrees");
      try {
         System.out.println((0.1 >= (Math.abs(clock.getHandAngle() - 92.584))) ? " - got true" : " - no joy");
      } catch (Exception e) {
         System.out.println(" - Exception thrown:\n\t" + e.toString());
      }
